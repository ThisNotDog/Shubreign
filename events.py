...
def scary_frog_event_I(user):
    print("ribbt.....ribbt....")
    choice = input("the frog appears to speak in tongue, and reaches out a hand." \
                   "type y to grab their hand, n to pass by")
    if choice == "y":
        print("the frog latches onto your arm, but it doesn't hurt, it actually feels great\n")
        user.defense += 1
        user.hp += 2
        print("your defense has been raised by 1\n your hp has been raised by 2")
    else:
        print("the frog eyes you with its indeterminable gaze" \
