...
player_1 = Player('player 1', 5, 5, 5, 20, 10, 1, 0)
player_1_equipment = Equipment(0, 0, 0, 0, 0)
player_1_status = Status(player_1.hp_lvl, player_1.mp_lvl)
...
#simple_fight(player_1, rofl_420)


#add_equipment('dog')
player_1.get_total_level


wizard_dilemna(player_1.day)
